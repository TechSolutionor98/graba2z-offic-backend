...
// // @desc    Generate Google Merchant JSON Feed
...
//           const productType =
//             product.parentCategory?.name + (product.category?.name ? ` > ${product.category.name}` : "")
...
// // @desc    Generate Google Merchant XML Feed (Fixed version)
...
//             console.warn(`Skipping product ${product._id} - missing essential data`)
//             continue
//           }
...
//               .substring(0, 5000)
//           } else {
//             cleanDescription = product.shortDescription || product.name
//           }
